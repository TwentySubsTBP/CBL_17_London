...
DATA_PATH = PROJECT_ROOT / "main" / "data"/"for training"/"crime_data_with_force_stop_search.parquet"

OUTPUT_PATH = PROJECT_ROOT / "main"/"data"/"outputs" / "model_predictions_by_lsoa_month_dashboard.csv"
EXPOSURE_PATH = PROJECT_ROOT / "patrol allocation" / "estimated_exposure_lsoa_month_clean.parquet"
