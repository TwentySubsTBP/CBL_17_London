...
# =====================================================================
# Find the exact absolute folder directory where LSOA.py is currently saved
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))

# 1. DATA_ROOT: Back out to 'data' directory, then step down into 'raw/extracted'
DATA_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "raw", "extracted"))

# 2. GEOJSON_PATH: Point directly to the file sitting right next to this script
GEOJSON_PATH = os.path.abspath(os.path.join(SCRIPT_DIR, "major_cities_2021_skeleton.geojson"))
...
>>>>>>> da7ae233db1398a657780f776b5474be34ecd356
