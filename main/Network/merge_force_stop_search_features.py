...
RAW_DATA_DIR = PROJECT_ROOT/"main" / "data" / "raw" / "extracted"

CRIME_FEATURES_PATH = PROJECT_ROOT /"main" / "data" /"for training"/ "crime_data.parquet"

OUTPUT_PATH = PROJECT_ROOT /"main" / "data" /"for training"/ "crime_data.parquet"
